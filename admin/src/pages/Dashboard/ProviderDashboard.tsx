    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600">{(user as any)?.businessName || 'Your Business'}</p>
            
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h3 className="text-sm font-medium text-gray-500">Contact Information</h3>
                <p className="text-gray-900">{user?.email}</p>
                <p className="text-gray-900">{(user as any)?.phone || '+1234567890'}</p>
              </div>
              
              <div>
                <h3 className="text-sm font-medium text-gray-500">Address</h3>
                <p className="text-gray-900">{(user as any)?.address || '123 Business Address, City'}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        <p className="text-gray-700">
          {(user as any)?.description || 'Your business description will appear here.'}
        </p>
      </div>
